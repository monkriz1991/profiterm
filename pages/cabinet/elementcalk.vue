...
const {
  ...
  error,
  refresh,
} = await useFetch("/api/elementcalk/", {
  method: "POST",
  headers: {
...
const addEmentcalk = async () => {
  let updatecalk = "api/update/updateelementcalk/";
  if (buttonEdit.value == true) {
    updatecalk = "api/add/addelementcalk/";
  }
      ...
      <div class="column is-8">
        <div class="content">
          ...
          <div class="drawer-add">
            <div v-if="elementcalk.result" class="drawer-cat-all">
              <div
                class="drawer-cat"
                v-for="item in elementcalk.result"
                :key="item"
              >
            ...
            <ClientOnly>
              ...
              >
                ...
                <div class="drawer-block">
                  <form @submit.prevent="addEmentcalk">
                    <div class="field">
                      <div class="control">
                        <input
                          class="input"
